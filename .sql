CREATE TABLE items (item_id SERIAL PRIMARY KEY, listType VARCHAR(55), item VARCHAR (10),amount VARCHAR (55);

CREATE TABLE users (user_id SERIAL PRIMARY KEY, household INTEGER, heat BOOLEAN, snow BOOLEAN, infant BOOLEAN, child, BOOLEAN, meds BOOLEAN, pets BOOLEAN, #ofdays INTEGER);
...
INSERT INTO items (listType, item, amount) VALUES ('base', 'personal hygene', 'per-person');
...
INSERT INTO items (listType, item, amount) VALUES ('base', 'insect repellant', 'per-person');
INSERT INTO items (listType, item, amount) VALUES ('base', 'whistle', 'per-person');
INSERT INTO items (listType, item, amount) VALUES ('base', 'matches lighter', 'per-person');
...
INSERT INTO items (listType, item, amount) VALUES ('base', 'therometer', 'per-household');
...
INSERT INTO items (listType, item, amount) VALUES ('child', 'child hygene items', 'per-person');
INSERT INTO items (listType, item, amount) VALUES ('child', 'cards', 'per-person');
